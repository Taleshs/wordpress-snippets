...
/**************************************************************************************/
function get_posts_load_more_scripts() {
...
add_action( 'wp_enqueue_scripts', 'get_posts_load_more_scripts' );


function get_posts_loadmore_ajax_handler(){
...
add_action('wp_ajax_loadmore', 'get_posts_loadmore_ajax_handler'); // wp_ajax_{action}
add_action('wp_ajax_nopriv_loadmore', 'get_posts_loadmore_ajax_handler'); // wp_ajax_nopriv_{action}
